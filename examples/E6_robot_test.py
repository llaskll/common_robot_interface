...
from cri.controller import E6Controller as Controller
...
def main():
    ...
    # work_frame = (311.1917, -24.3149, 76.4690, -180, 0, 0)  # base frame: x->front, y->left, z->up, rz->anticlockwise
    work_frame = (313.1917, -25.3149, 151.4690, -180, 0, 0)  # base frame: x->front, y->left, z->up, rz->anticlockwise  collect data

    with SyncRobot(Controller(ip='192.168.5.1')) as robot:
        # Set TCP and coordinate frame
        robot.coord_frame = work_frame
        robot.tcp = (0, 0, -80, 0, 0, 150)
        # robot.tcp = (0, 0, -100, 0, 0, 90)
        robot.speed = 10
